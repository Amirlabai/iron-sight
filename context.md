...
- Map: Leaflet, origin corridors, country silhouettes (`countries.json`), city boundary strokes, `TacticalMotionLayer` (missiles), `TrackingDrone` (drones). Motion sprites: `dashboard/public/sprites/rocket.png`, `drone.png` (32px on map, bearing offset −45° for NE-oriented art).
