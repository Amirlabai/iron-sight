...
- Sprites: `rocket.png`, `drone.png`, `anti-missile.png`, `avatar.png` (32px); interceptors at 20px; user location uses `avatar.png` when geo is on. Source: `sprites/sprite files/*.newt` → `node scripts/newt-to-png.mjs`.
